...
<style>
	body{font-family: Calibri; color: #11273E;}
</style>


<a href="viewcreateuser.htm"><img name="JC_CU" src="../images/JC_CU.jpg" width="1280" height="18" id="JC_CU" alt="" /></a>
...
function detalle(idform){
	window.open( "datosformularioJC.htm?idform="+idform, "ventana1", "height=450,width=700,left=300,location=yes,menubar=no,resizable=no,scrollbars=yes,status=no,titlebar=yes,top=300" );
}
</script>
   ...
   <table>
    ...
    <c:forEach var="salida" begin="0" items="${listado}">
	    ...
	    <tr bgcolor="${color }" onclick="detalle(${salida.id_formul})">
	        <td align="center" width = "300" > ${salida.nombre}</td>
	        <td align="center" width = "200"> ${salida.NOM_FALLA}</td>
	        <td align="center" width = "100"> ${salida.NUM_SALA}</td>
	        <td align="center" width = "100"> ${salida.NUM_PC}</td>
	        <td align="center" width = "353"> ${salida.DESC_FALLA}</td>
	        <td align="center" width = "200"> ${salida.nom_estado}</td>
	    </tr>
	</c:forEach>
   </table>
 </div>	
