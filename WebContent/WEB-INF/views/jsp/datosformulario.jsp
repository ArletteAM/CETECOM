	...
	<div class="l-page">
		<div class="header-wrapper">
			<header class="l-header" role="banner">
				...
				<tr>
					<td>
						<INPUT TYPE="radio" value="1" id="rdFred" name="idestado" >&nbsp;Aceptado
					</td>
				</tr>
				<tr>
					<td>
						<INPUT TYPE="radio" value="2" id="rdFext" name="idestado">&nbsp;En Proceso
					</td>
				</tr>
				<tr>
					<td>
						<INPUT TYPE="radio" value="3" id="rdFint" name="idestado">&nbsp;Rechazado
					</td>
				</tr>
	</table>
